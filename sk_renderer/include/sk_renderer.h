...
static const skr_blend_state_t skr_blend_off = {
	skr_blend_zero, skr_blend_zero, skr_blend_op_add,
	skr_blend_zero, skr_blend_zero, skr_blend_op_add
};

static const skr_blend_state_t skr_blend_alpha = {
	skr_blend_src_alpha, skr_blend_one_minus_src_alpha, skr_blend_op_add,
	skr_blend_one, skr_blend_one_minus_src_alpha, skr_blend_op_add
};

static const skr_blend_state_t skr_blend_additive = {
	skr_blend_src_alpha, skr_blend_one, skr_blend_op_add,
	skr_blend_one, skr_blend_one, skr_blend_op_add
};
