...
# Compile SDL2 Java sources
set(SDL2_JAVA_SRC "${CMAKE_BINARY_DIR}/_deps/sdl2-src/android-project/app/src/main/java")
set(ANDROID_JAR "${ANDROID_SDK_ROOT}/platforms/android-${CMAKE_SYSTEM_VERSION}/android.jar")
file(GLOB_RECURSE SDL2_JAVA_FILES "${SDL2_JAVA_SRC}/org/libsdl/app/*.java")
add_custom_command(
	DEPENDS ${SDL2_JAVA_FILES}
	OUTPUT  ${APK_TEMP}/obj/classes.dex
	COMMAND ${JAVAC} -d ${APK_TEMP}/obj -classpath ${ANDROID_JAR} -sourcepath ${SDL2_JAVA_SRC} ${SDL2_JAVA_FILES}
	COMMAND ${D8} --release --classpath ${ANDROID_JAR} ${APK_TEMP}/obj/org/libsdl/app/*.class --output ${APK_TEMP}/obj
	COMMENT "Building SDL2 Java classes for APK" )
...
add_custom_target(run_apk
	...
	COMMAND ${ANDROID_SDK_ROOT}/platform-tools/adb shell am start -n ${ANDROID_PACKAGE_NAME}/org.libsdl.app.SDLActivity
